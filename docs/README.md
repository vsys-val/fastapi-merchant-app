...
flowchart TB
  ...
  subgraph Verificação
    MT[Matriz de testes<br/>T01–T50]
...
| [decisoes/](decisoes/README.md) | 15 ADRs de produto e arquitetura, com alternativas e consequências |
...
| [casos-de-uso.md](casos-de-uso.md) | UC01–UC18 com fluxos principal, alternativos e de exceção |
...
| Documento | Conteúdo |
|---|---|
| [matriz-testes.md](matriz-testes.md) | T01–T50 ligados a requisitos e casos de uso |
