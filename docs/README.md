...
flowchart TB
  ...
  subgraph Verificação
    MT[Matriz de testes<br/>T01–T33]
...
| [decisoes/](decisoes/README.md) | 10 ADRs de produto e arquitetura, com alternativas e consequências |
...
| Documento | Conteúdo |
|---|---|
| [requisitos.md](requisitos.md) | 15 requisitos funcionais, 28 regras de negócio, 6 não funcionais e o que ficou fora do escopo |
| [historias-usuario.md](historias-usuario.md) | 13 histórias em 5 épicos, MoSCoW, critérios de aceite em Gherkin e definição de pronto |
| [casos-de-uso.md](casos-de-uso.md) | UC01–UC14 com fluxos principal, alternativos e de exceção |
...
| [diagramas.md](diagramas.md) | Contexto, casos de uso, ER, ciclo de vida do produto, sequência e deploy (Mermaid) |

### Qualidade e operação

| Documento | Conteúdo |
|---|---|
| [matriz-testes.md](matriz-testes.md) | T01–T33 ligados a requisitos e casos de uso |
