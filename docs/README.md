...
flowchart TB
  ...
  subgraph Verificação
    MT[Matriz de testes<br/>T01–T49]
...
| [decisoes/](decisoes/README.md) | 14 ADRs de produto e arquitetura, com alternativas e consequências |
...
| Documento | Conteúdo |
|---|---|
| [matriz-testes.md](matriz-testes.md) | T01–T49 ligados a requisitos e casos de uso |
